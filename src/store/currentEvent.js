...
export default {
    ...
    validations: {
      title: {
        required: helpers.withMessage(
          "Fill in a title for your event.",
          required
        ),
        $autoDirty: true,
      },
      ...
      path: {
        ...
        isPath: helpers.withMessage(
          "Only use lowercase letters and numbers, with hyphens in between: my-event-path",
          helpers.regex(/^[a-z|0-9]+(-[a-z|0-9]+)*$/)
        ),
        $autoDirty: true,
      },
      callToAction: {
  ...
  actions: {
    ...
    subscribeToDatabaseID({ state, rootState, commit }, eventID) {
