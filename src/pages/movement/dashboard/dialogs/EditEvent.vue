          ...
          <q-card-section>
            <div class="q-gutter-y-sm">
              ...
              <q-input
                ...
                :errorMessage="
                  mixin_mergeErrorMessages(
                    this.v$.event.data.onlineLink.$errors
                  )
                "
              >
            ...
            <q-card>
              <q-card-section>
                <div class="q-gutter-sm">
                  <div>
                    Attach a form to ask additional questions to participants,
              ...
              <q-card-section>
                <div class="q-gutter-sm">
                  <q-input
                    ...
                    :errorMessage="
                      mixin_mergeErrorMessages(
                        this.v$.event.data.document.$errors
                      )
                    "
                  >
                    <template v-slot:append>
                      ...
                      >
                        <q-tooltip
                          >Google Docs integration coming soon</q-tooltip
                        >
                      </q-btn>
                    </template>
                  </q-input>
