      ...
      <q-card-section>
        <div class="q-gutter-y-sm">
          ...
          <div class="text-caption q-mt-md">
            It is not yet possible to change your email or city.
          </div>
          <q-input
...
export default {
  ...
  computed: {
    ...
    lastName: {
      get() {
        return this.$store.state.currentUser.data.lastName;
      },
      set(value) {
        this.$store.commit("currentUser/update", { lastName: value });
      },
    },
    phoneNumber: {
      get() {
    ...
    emailAddress: {
      get() {
        return this.$store.state.currentUser.data.emailAddress;
      },
      set(value) {
        this.$store.commit("currentUser/update", { emailAddress: value });
      },
    },
    location: {
      get() {
        return this.$store.state.currentUser.data.location;
      },
      set(value) {
        this.$store.commit("currentUser/update", { location: value });
      },
    },
  },
  methods: {
