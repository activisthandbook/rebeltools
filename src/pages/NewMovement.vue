  ...
  <div  class="q-gutter-y-md">
    ...
    <q-card>
      <q-card-section>
        ...
        <q-input label="Name of movement" placeholder="Climate Justice Now!" outlined v-model="newMovement.name"/>
        <q-input label="URL Path" placeholder="climate-justice-now" outlined v-model="newMovement.path" hint="Only use lowercase letters and dashes (my-movement)." class="q-mt-md"/>
      </q-card-section>
    </q-card>
    <q-card>
      <q-card-section>
    ...
    <q-btn label="Create movement" @click="createMovement()" no-caps color="primary" icon-right="mdi-arrow-right" :loading="loading">
