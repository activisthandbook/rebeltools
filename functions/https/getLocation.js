...
exports.getLocation = functions
  .region("europe-west1")
  .https.onCall((data, context) => {
    functions.logger.info(
      "🧭 getLocation rawRequest",
    ...
    const response = {
      ...
      lat: Number(
        context.rawRequest.headers["x-appengine-citylatlong"].split(",")[0]
      ),
      long: Number(
        context.rawRequest.headers["x-appengine-citylatlong"].split(",")[1]
      ),
    };
